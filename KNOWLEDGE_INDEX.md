...
| kernel design and iteration | `knowledge/kernels/kernel-autoresearch-loop.md`, `knowledge/kernels/jit-architecture.md`, `knowledge/kernels/sass-mma-analysis.md` | how should an agent optimize a kernel, how does the JIT path work, what did the compiled MMA path become | `kernel-performance-expert` |
...
| RL workflow contracts | `knowledge/rl/workflow-contracts.md`, `knowledge/rl/tree-training.md` | how should rollout and reward responsibilities split, how does multi-turn or tree training affect data shape | `rl-workflow-expert` |
| serving systems | `knowledge/serving/gateway-serving-patterns.md`, `knowledge/serving/disaggregated-serving.md`, `knowledge/serving/torch-compile-coverage.md` | how should sessions and gateways work, when should P/D be used, why did a fast kernel regress E2E serving | `serving-systems-expert` |
