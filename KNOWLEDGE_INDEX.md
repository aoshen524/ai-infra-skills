...
| RL workflow contracts | `knowledge/rl/workflow-contracts.md`, `knowledge/rl/tree-training.md`, `knowledge/rl/slime-repo-navigation.md` | how should rollout and reward responsibilities split, how does multi-turn or tree training affect data shape, where should I look in SLIME first | `rl-workflow-expert` |
