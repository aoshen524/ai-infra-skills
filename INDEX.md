...
| audit latest changes from the 13 tracked upstream repos | `.claude/skills/04-review-plan/upstream-refresh.md` | `COVERAGE_AUDIT.md`, `CLAUDE.md`, `README.md`, matching `knowledge/*` or `.claude/*` targets |
